...
import '../app/domain/repository/app_setting_storage.dart' as _i797;
import '../app/domain/usecase/get_setting_usecase.dart' as _i273;
import '../app/domain/usecase/update_setting_usecase.dart' as _i884;
...
Future<_i174.GetIt> init(
  ...
  gh.factory<_i797.AppSettingStorage>(
    () => appSettingModule.appLocalDataSource,
  );
  gh.factory<_i884.UpdateSettingUsecase>(
    () => appSettingModule.updateSettingUsecase,
  );
  gh.factory<_i273.GetSettingUsecase>(() => appSettingModule.getSettingUsecase);
  ...
  gh.factory<_i257.AccountRestClient>(
    () => _i257.AccountRestClient.new(
      gh<_i361.Dio>(),
