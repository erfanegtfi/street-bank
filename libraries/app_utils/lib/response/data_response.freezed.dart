...
mixin _$DataResponse<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(T res) success,
    required TResult Function(GeneralError error) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T res)? success,
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$DataResponseCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'DataResponse<$T>.success(res: $res)';
  }
...
abstract class Success<T> implements DataResponse<T> {
  const factory Success(final T res) = _$SuccessImpl<T>;
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$DataResponseCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'DataResponse<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements DataResponse<T> {
  const factory Error(final GeneralError error) = _$ErrorImpl<T>;
